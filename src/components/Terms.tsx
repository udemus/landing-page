...
export const Terms = () => (
  <PrivacyTerms>
    ...
    <p>Welcome to Udemus!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Udemus's Website, located at https://udemus.com.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Udemus if you do not agree to take all of the terms
    ...
    <p>
      We employ the use of cookies. By accessing Udemus, you agreed to use
      cookies in agreement with the Udemus's Privacy Policy.{' '}
    </p>
    ...
    <p>
      Unless otherwise stated, Udemus and/or its licensors own the intellectual
      property rights for all material on Udemus. All intellectual property
      rights are reserved. You may access this from Udemus for your own personal
      use subjected to restrictions set in these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Udemus</li>
      <li>Sell, rent or sub-license material from Udemus</li>
      <li>Reproduce, duplicate or copy material from Udemus</li>
      <li>Redistribute content from Udemus</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Udemus does not
      filter, edit, publish or review Comments prior to their presence on the
      website. Comments do not reflect the views and opinions of Udemus,its
      ...
      applicable laws, Udemus shall not be liable for the Comments or for any
    ...
    <p>
      Udemus reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Udemus a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      hyperlink compensates the absence of Udemus; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to Udemus. Please include your name, your organization name,
    ...
    <p>
      No use of Udemus's logo or other artwork will be allowed for linking
