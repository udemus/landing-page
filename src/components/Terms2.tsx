    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Udemus.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          ...
          help of the{' '}
          <a
            href="https://www.termsfeed.com/terms-conditions-generator/Terms2.tsx"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Udemus, accessible from{' '}
          <a
            href="https://udemus.com"
